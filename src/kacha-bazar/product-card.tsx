                ...
                <Grid container spacing={2} >
                    {
                        state.popularProductsForDailyShoping.map(x => (
                            <Grid item xs={6} md={4} lg={2} >
                                <div onClick={() => { state.getID = x.id; setIsDialogOpen(true) }} id="product-card" style={{ border: '1px solid #F1F2F3', borderRadius: '10px', paddingLeft: '15px', width: '100%', paddingRight: '15px', paddingBottom: '15px' }} >
